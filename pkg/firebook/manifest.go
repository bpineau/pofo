...
var Categories = []Category{
	...
	},
	{
		...
		Articles: []Article{
			...
			{"guardrails-morningstar", "Les guardrails modernes (Morningstar) : l'état de l'art", "Le juge honnête de Morningstar, l'indicateur par risque de Kitces-Tharp, et la version exécutable avec pofo en instrument."},
