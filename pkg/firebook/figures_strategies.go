...
var (
	bengenStart  = 1966
	bengenRuin   = 1994
	bengenRates  = []float64{4.00, 4.49, 4.24, 4.29, 5.03, 5.09, 4.95, 4.80, 5.94, 8.18, 7.59, 7.23, 8.67, 9.95, 11.12, 11.60, 14.12, 13.64, 14.23, 15.67, 15.12, 15.44, 18.31, 20.91, 22.31, 29.78, 34.96, 51.93}
	bengenWealth = []float64{600.0, 535.1, 565.6, 559.9, 477.4, 471.3, 484.4, 499.5, 403.9, 293.3, 316.1, 332.0, 276.7, 241.3, 215.9, 206.9, 170.0, 176.0, 168.6, 153.2, 158.7, 155.5, 131.1, 114.8, 107.6, 80.6, 68.6, 46.2}
)
...
var pourcentageReturns = []float64{
	-0.1505, -0.2279, 0.1736, 0.1366, -0.1017, -0.0452, -0.0064, 0.0782,
	-0.0706, 0.2056, 0.1096, 0.0589,
}
...
var bengenVintages = []float64{
	1880, 788, 459, 621, 1328, 542, 486, 515, 0, 280, 0, 0, 0, 56, 0, 0, 341, 355, 185, 20,
	940, 2873, 2064, 1620, 2736, 3203, 4148, 4323, 5728, 3513, 3527, 3812, 3000,
}
