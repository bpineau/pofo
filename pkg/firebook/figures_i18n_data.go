...
var figureDict = map[string]string{
	...
	"1954-1980 : elle coûte sur les vingt-sept départs":                  "1954-1980: it costs on all twenty-seven departures",
	"elle rapporte sur les seize suivants":                               "it pays on the sixteen that follow",
	...
	"en 1966, 3,96 % avec l'intermédiaire, 4,03 % au monétaire, 3,69 % à la longue.":                                               "in 1966, 3.96% on the intermediate sleeve, 4.03% on bills, 3.69% on the long one.",
	...
	"douleur-prime|Droite des moindres carrés sur les cinq actifs à salaire, or exclu (R² = 0,86). Séries déflatées par l'IPC américain :":              "Least squares through the five wage-earning assets, gold excluded (R² = 0.86). Series deflated by the US CPI:",
	...
	"importance-annees|les dix premières années : 71 % de l'issue":                                                                                         "the first ten years: 71% of the outcome",
	"importance-annees|année de retraite  →":                                                                                                               "retirement year  →",
	"importance-annees|les deux premières années : 21 %":                                                                                                   "the first two years: 21%",
	"importance-annees|les vingt dernières : 6 % en tout":                                                                                                  "the last twenty: 6% between them",
	"importance-annees|Le quart le plus court de l'horizon porte 71 % du résultat : la vigilance se date, elle ne s'étale pas.":                            "The shortest quarter of the horizon carries 71% of the result: vigilance is dated, not spread out.",
	...
	"importance-annees|Lue sur la richesse finale plutôt que sur le succès, la concentration tombe à 59 % pour la première décennie.":                      "Read on final wealth rather than on success, the concentration drops to 59% for the first decade.",
	"importance-annees|Le texte annonce 70 % au moins, la mesure en donne 71, stable de 67 à 77 % selon l'horizon, le retrait et le portefeuille.":         "The text says at least 70%, the measurement gives 71, stable between 67 and 77% across horizon, withdrawal and portfolio.",
