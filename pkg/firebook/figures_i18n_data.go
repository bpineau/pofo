...
var figureDict = map[string]string{
	...
	"tous-temps-curseur|La pire année civile recule à chaque dose, de −16,6 % sans poche à −1,0 % à 40 % : aucune dose n'a aggravé une mauvaise année.":             "The worst calendar year recedes with every dose, from −16.6% with no sleeve to −1.0% at 40%: no dose ever made a bad year worse.",
