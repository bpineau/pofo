...
var figureDict = map[string]string{
	...
	"panier-mediane-plancher|+0,78 pt":                                                                                                           "+0.78 pt",
	"panier-mediane-plancher|Le panier échange 25 % de médiane contre 0,78 point de retrait sûr : on se dimensionne sur le percentile 5.":                         "The basket trades 25% of the median for 0.78 points of safe withdrawal: you size the plan on the 5th percentile.",
	...
	"importance-annees|les dix premières années : 70 % de l'issue":                                                                                         "the first ten years: 70% of the outcome",
	...
	"importance-annees|Le quart le plus court de l'horizon porte 70 % du résultat : la vigilance se date, elle ne s'étale pas.":                            "The shortest quarter of the horizon carries 70% of the result: vigilance is dated, not spread out.",
