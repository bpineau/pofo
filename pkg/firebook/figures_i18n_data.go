...
var figureDict = map[string]string{
	...
	"à pire drawdown égal, l'échelle rend 9,6 %":                 "at equal worst drawdown, the mixes return 9.6%",
	"soit 3,0 points de plus par an":                             "that is 3.0 points more a year",
	...
	"douleur-prime|Droite des moindres carrés sur les cinq actifs à salaire, or exclu (R² = 0,85). Séries déflatées par l'IPC américain :":              "Least squares through the five wage-earning assets, gold excluded (R² = 0.85). Series deflated by the US CPI:",
	...
	"tous-temps-curseur|Le plateau : de 0 à 30 % de dose, le recul remonte de 16 points ; de 30 à 40 %, de 0,2 point de plus, pour 0,13 de rendement.":              "The plateau: from 0 to 30% of dose the drawdown recovers 16 points; from 30 to 40%, 0.2 points more, for 0.13 of return.",
