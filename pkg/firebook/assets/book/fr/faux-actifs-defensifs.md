...
Un actif défensif n'a qu'un seul métier. Tenir, ou monter, quand la poche actions s'effondre. C'est un métier exigeant, et peu d'actifs le font vraiment ([[actifs-defensifs]] passe les vrais défenseurs en revue). Mais le mot « défensif » se vend bien. Le marché habille donc en tenue de défense quantité de produits qui cherchent en réalité du rendement, ou qui ne sont qu'une variante d'actions. Ils font baisser un chiffre sur une brochure, la volatilité, le drawdown moyen, ou ils affichent un gros dividende. Ils ne font pas le travail, protéger le percentile 5, celui qui dimensionne tout le plan ([[sequence-des-rendements]]).
...
Les fonds **high dividend** cherchent les plus gros rendements du marché. Or un rendement élevé signale souvent une valeur en difficulté (un value trap). Le bêta reste de 0,8 à 0,9, les drawdowns sont ceux des actions, et le dividende se coupe dans les crises (les dividendes du S&P 500 ont chuté d'environ 25 % en 2008-2009). On récolte le drawdown des actions plus un revenu qui maigrit quand on en a besoin. C'est le « yield illusion », l'illusion du rendement, que démonte ERN ([[serie-ern]], [[primes-de-risque]]).
...
Les **covered calls** (la vente d'options d'achat couvertes, ou buy-write, popularisée par les fonds de type QYLD ou JEPI) se vendent comme « du revenu, avec moins de volatilité ». La prime encaissée amortit les petites baisses et lisse le chiffre de volatilité. Mais l'asymétrie joue à l'envers. On garde **toute** la baisse et on plafonne la hausse. Dans un krach de −40 %, la prime (quelques pour cent par an) n'entame presque rien. Dans le rebond, le plafond ampute la reprise juste quand elle rattraperait la perte. Économiquement, c'est une position vendeuse de volatilité, donc une vente d'assurance. Elle perd exactement quand l'assurance devrait payer ([[long-volatility]]). Le « revenu » distribué est pour l'essentiel votre propre capital qu'on vous rend, plus les gains auxquels vous avez renoncé. C'est une stratégie de rendement, pas une défense.
...
Le test est celui du chapitre voisin ([[actifs-defensifs]]). Posez la question « qu'a fait ce produit en 2008 et en 2022 ? ». Un vrai défensif a un bon bulletin dans au moins l'un des deux, sans catastrophe dans l'autre. Aucun produit de ce chapitre ne le passe. La doctrine qui en découle est simple. Gardez les vrais défensifs pour le métier de défense (le cash, la duration d'État, les obligations indexées, l'or, le trend, [[or-en-retrait]], [[obligations-indexees]], [[managed-futures]]). Et si vous détenez l'un de ces faux défensifs pour ses mérites propres, comptez-le dans la poche de rendement, jamais dans le plancher.

::: attention Les deux pièges du moment
Deux faux défensifs sont particulièrement vendus en ce moment, et méritent une vigilance à jour. Les fonds à revenu de covered calls (QYLD, JEPI et leurs clones européens) séduisent par un rendement affiché à deux chiffres. Ce rendement est en grande partie une restitution de capital, et la stratégie perd sa hausse dans les rebonds, ceux qui suivent justement les krachs qu'un rentier doit traverser ([[marche-baissier-en-retraite]]). Le private equity « retail » (ELTIF, fonds evergreen) promet la performance des institutionnels avec une volatilité de fonds euros. La volatilité basse est un artefact comptable, l'illiquidité est réelle, et les frais mangent l'avantage supposé. Devant l'un et l'autre, revenez au test de crise et au cahier des charges ([[actifs-defensifs]]).
:::

::: exemple La poche « revenu » qui n'a pas défendu
Un couple remplace sa poche défensive de 20 % (obligations et or) par une poche « revenu » de 20 %, moitié high dividend, moitié covered calls, séduit par un rendement distribué de 7 %. Sur le papier, le portefeuille verse plus et paraît moins volatil. Rejouez maintenant 2008-2009. La poche high dividend tombe avec les actions, et son revenu maigrit au pire moment, quand les dividendes de l'indice sont coupés. La poche covered calls amortit un peu la chute grâce aux primes encaissées, puis ne capte qu'environ 70 % du grand rebond de 2009, celui qui devait réparer la perte. En face, la poche défensive abandonnée aurait monté, portée par les emprunts d'État longs et par l'or. Le revenu élevé n'a rien protégé, car il n'était qu'un prélèvement sur un capital resté 100 % actions. Le test de crise l'avait annoncé avant l'achat.
:::
...
- La plupart de ces produits sont légitimes en tant que pari de rendement ou choix de style. L'erreur est de les compter dans le plancher. Gardez les vrais défensifs pour la défense ([[actifs-defensifs]]).

---

## Pour aller plus loin

- Early Retirement Now, volets 29-31 et 40 (le « yield illusion » des actions à dividendes) ([[serie-ern]]).
...
- Sur les covered calls, la littérature sur les indices BXM/PUT du CBOE : le profil vendeur de volatilité, rendement et risque réels.
- Dans ce livre : [[actifs-defensifs]] (les vrais défenseurs et le cahier des charges), [[primes-de-risque]] (ce que chaque brique rapporte vraiment), [[long-volatility]] (pourquoi vendre la volatilité paie mal l'assurance), [[facteurs-fama-french]] (le low vol comme facteur), [[immobilier-en-retrait]] (REIT contre pierre en direct), [[obligations-en-retrait]] (pourquoi la duration d'État défend, pas le high yield).
