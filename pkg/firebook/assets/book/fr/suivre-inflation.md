...
- Trois inflations : l'officielle (IPC/IPCH : celle des pensions, des linkers, et du déflateur `^HICP-FR` de pofo), la vôtre (votre panier : typiquement indice +0,2 à +0,5 pour un retraité, santé et services en tête), et celle du plan (officielle + dérive explicite).
