...
- **Les services en général** (aide, entretien, restauration, assurances). Ils sont intensifs en main-d'œuvre locale, donc leurs prix suivent les salaires, historiquement environ 1 point au-dessus des biens. Et un budget de retraité est plus servi que la moyenne.
