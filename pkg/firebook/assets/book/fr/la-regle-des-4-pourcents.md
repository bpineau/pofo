...
Cette page explique exactement ce qu'elle dit (c'est plus subtil que la version de comptoir), d'où viennent ses chiffres, ce qu'elle suppose sans le dire, et pourquoi l'état de l'art la traite aujourd'hui comme un excellent point de départ et un mauvais point d'arrivée. À la fin, vous saurez l'utiliser pour ce qu'elle vaut : un ordre de grandeur, pas un plan. Et pour comprendre pourquoi, mathématiquement, ce chiffre-là tient et ce qui le ferait bouger, le calcul est démonté étage par étage dans [[les-maths-du-4-pourcent]].

::: cle Ce que la règle dit exactement
Année 1 : retirez 4 % du capital initial (40 000 € pour 1 000 000 €). Années suivantes : retirez le **même** montant ajusté de l'inflation (41 200 € si l'inflation a été de 3 %), quoi que fasse le portefeuille. Dans les données de Bengen, sur toutes les fenêtres de 30 ans américaines depuis 1926, un portefeuille 50 à 75 % actions n'a jamais été épuisé par ce régime. « Sûr » signifie ici : n'a jamais échoué dans le passé américain observé. Rien de plus.
:::
...
**4. Les valorisations de départ déplacent le taux.** Les pires millésimes ont tous démarré sur des marchés chers (CAPE élevé). Les règles modernes conditionnent donc le taux initial aux valorisations ([[valorisations-et-cape]], [[regles-cape]]). C'est l'une des améliorations les mieux établies.

::: science Où la recherche situe le « vrai » chiffre aujourd'hui
Pour une retraite précoce (horizon de 45 ans et plus), portefeuille mondial diversifié, sans flexibilité ni revenu complémentaire, la littérature converge vers 3,0 à 3,5 % en régime rigide (ERN, 3,25 % ; Morningstar 2025, sur 30 ans avec rendements prospectifs, 3,9 % ; Anarkulova-Cederburg, échantillon mondial, plutôt 2,3 à 2,7 % pour les plus pessimistes, une borne basse discutée). Chaque protection ajoutée (flexibilité des dépenses [[flexibilite-realite]], revenus partiels [[retour-au-travail]], retraite légale future [[retraite-legale]], guardrails [[guardrails-morningstar]]) remonte ce chiffre, parfois au-delà de 4 %. Le taux sûr n'est pas une constante de la nature. C'est la sortie d'un modèle, fonction de vos hypothèses et de vos marges.
:::
...
**Excellente comme point de départ du dimensionnement.** Viser 25 fois ses dépenses, puis affiner avec un vrai modèle ([[utiliser-la-page-fire]]) et sa situation réelle. C'est la bonne séquence. L'erreur n'est pas de commencer par 4 %, c'est de s'y arrêter.
...
Reprenons Camille : 1 M€, 60/40 mondial, départ à 45 ans, 40 000 €/an indexés. Ce que disent les trois familles de modèles ([[historique-vs-parametrique]]) sur 45 ans : le paramétrique central calibré donne typiquement une ruine de l'ordre de 10 à 15 %, le rejeu de l'échantillon mondial davantage, les fenêtres historiques du portefeuille moins. À 3,4 % (34 000 €/an), la ruine centrale passe sous 5 % ; à 4 % avec 800 €/mois de retraite légale à partir de 67 ans, elle repasse aussi sous 5 %. Voilà la règle bien utilisée : un point de départ, trois leviers testés, une décision informée.
:::

## L'essentiel à retenir

- La règle : 4 % du capital initial, puis le même montant indexé sur l'inflation ; jamais mise en défaut sur 30 ans dans les données américaines de Bengen.
...
- Bengen lui-même, interviews récentes. Il considère aujourd'hui 4 % comme trop conservateur pour un portefeuille plus diversifié, tout en rappelant que sa règle ne vaut que dans le cadre américain sur 30 ans. Les deux mouvements (le sien vers le haut, celui de la recherche « monde + horizon long » vers le bas) illustrent bien que le chiffre dépend du cadre.
