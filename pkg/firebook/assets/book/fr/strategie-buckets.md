...
Un portefeuille en buckets (2 ans de cash + 6 ans d'obligations + le reste en actions) est un portefeuille ~7/21/72 avec un matelas. Rien de plus, rien de moins. Toute sa performance viendra de cette allocation et des règles de flux entre les buckets. Et ces règles, une fois écrites noir sur blanc, se révèlent être soit le rééquilibrage classique (alors dites-le et simplifiez), soit une décision au coup par coup (alors c'est du timing, avec son bilan connu). Les buckets sont un excellent **langage** et une médiocre **mécanique**.
:::
...
Les simulations comparées d'ERN confrontent les buckets à des portefeuilles équivalents sur toutes les cohortes historiques (volet 48, prolongé par la discussion du volet 55). La conclusion est nette. Aucune configuration de buckets ne domine son jumeau total-return. Les variantes discrétionnaires font pire, par dérive d'allocation. Les mécaniques font pareil, en plus compliqué. Kitces arrive au même point par la comptabilité des flux, et sa formule est restée. Les buckets sont pour lui un « mirage d'allocation » (asset allocation mirage), plus utiles pour expliquer un plan à un client que pour le gérer. Et la recherche académique sur la comptabilité mentale (Thaler, Shefrin) explique **pourquoi** la stratégie séduit malgré tout. Les comptes mentaux séparés réduisent l'anxiété et les erreurs de panique. Ce bénéfice est réel, comportemental, indépendant de la mécanique. Autrement dit, la littérature ne dit pas « les buckets ruinent le plan ». Elle dit « les buckets n'ajoutent rien mécaniquement, et peuvent aider psychologiquement ». C'est ce verdict précis qui permet d'agir.
:::

## Ce qui survit : les buckets comme langage

Prenons le verdict au sérieux dans les deux sens. Si le bénéfice des buckets est comportemental, il est **réel** pour qui en a besoin. L'effet anti-panique des comptes mentaux est documenté. Un ménage qui **tient** son plan en buckets là où il aurait capitulé en « 65/35 » a gagné l'essentiel ([[psychologie-du-retrait]], [[cash-buffer]]). La conclusion pratique est simple. **Gardez les buckets comme présentation, exigez du plan qu'il soit, sous le capot, un portefeuille explicite.** Concrètement, trois exigences et un juge.
...
- **Le bucket 2 en version contractuelle quand le plancher l'exige.** Si l'idée « l'argent de 2028-2035 est sécurisé » vous est précieuse, rendez-la **vraie**. Montez une échelle d'obligations détenues à terme, linkers de préférence, adossée année par année ([[echelle-obligataire]], [[obligations-indexees]]). C'est le bucket 2 sans l'ambiguïté, avec un contrat à la place d'une intention.
