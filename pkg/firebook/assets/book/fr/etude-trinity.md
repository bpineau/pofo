...
- **Le biais du survivant géographique.** Les données Ibbotson commencent en 1926 aux États-Unis, le pays qui a gagné deux guerres mondiales sur le sol des autres avant de finir superpuissance. Le siècle développé complet raconte une histoire plus dure ([[anarkulova-cederburg]]) ; c'est le panel JST (16 pays, 1870-2020) que rejouent les modèles dits « broad sample ».
...
- La méthode se refait sur votre propre plan, avec n'importe quel simulateur de rejeu historique : faites-le, un millésime vécu vaut mille probabilités.
