...
- Répartition : PEA pour les actions, AV pour le fonds euros (et des UC propres), CTO pour tout le reste. Sa fiscalité au prix moyen pondéré rend les premières années de retrait très peu taxées.
...
- L'AMF ([amf-france.org](https://www.amf-france.org)) : les documents d'informations clés (DIC) et la pédagogie officielle des ETF.
