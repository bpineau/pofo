...
Un future sur indice ne demande en garantie qu'une fraction de son exposition. Un fonds peut donc détenir 90 % d'actions au comptant et y superposer 60 % d'obligations via futures, soit 150 % d'exposition pour 100 € investis, financée implicitement au taux court. Détenir 67 € de ce fonds équivaut à un 60/40 classique. Il vous reste alors 33 € pour loger du trend ou de l'or sans rien avoir vendu. Ici, le levier ne sert pas à amplifier un pari. Il sert à faire tenir plus de diversification dans le même portefeuille.
:::
...
**Le coût de financement d'abord.** L'exposition au-delà de 100 % est financée au taux monétaire, le prix implicite d'un future ([[levier-et-marges]] pour la mécanique). L'étage empilé ne rapporte donc pas son rendement brut, mais son rendement **moins le cash**. Empiler des obligations qui rendent 3 % quand le taux court est à 3,5 % détruit de la valeur. La même pile devient rentable quand la courbe se pentifie. Un étage empilé capture donc une prime au-dessus du cash, jamais un rendement absolu. D'où le critère d'admission de tout étage : a-t-il une espérance positive, nette du taux court et des frais ?

**Le frein de la volatilité (volatility drag) ensuite.** Le levier amplifie la volatilité, et la volatilité coûte en rendement composé ([[rendements-arithmetiques-geometriques]]). Un 60/40 à levier 1,5 subit un drag supérieur au 60/40 simple. Tant que les deux jambes se compensent, avec une corrélation actions-obligations négative ou nulle, l'effet reste petit devant la prime ajoutée. Ce qui mène droit au troisième point.

**La corrélation enfin, leçon de 2022.** Cette année-là, actions et obligations ont chuté ensemble. Le 90/60 a encaissé environ une fois et demie la perte du 60/40, de l'ordre de −25 % contre −17 %. Le levier ne crée pas de nouvelle défense : il agrandit ce qu'on lui donne. Empiler des obligations sur des actions n'aide donc que dans les régimes où les obligations défendent ([[regimes-de-marche]]). D'où le meilleur argument, en décumulation, pour empiler un actif à corrélation vraiment basse plutôt que de la duration seule. Le trend est ici le candidat naturel.

::: science D'où vient l'idée : le portable alpha institutionnel
Dans les années 1980, PIMCO lance StocksPLUS. L'exposition actions passe par des futures, qui ne mobilisent que peu de capital. Le reste est investi en obligations gérées activement. Si celles-ci battent le cash (le coût du future), le fonds bat l'indice actions. Les caisses de retraite ont généralisé ce principe sous le nom de portable alpha, l'idée de transporter une source de rendement au-dessus d'un beta. La crise de 2008 en a révélé la limite : des piles illiquides financées à court terme et des appels de marge en pleine panique. La version moderne « return stacked » en retient la leçon. Elle n'empile que des instruments liquides (futures sur indices, obligations d'État, programmes de trend), avec un levier plafonné et un rebalancement quotidien dans le fonds, sans appel de marge pour le porteur. Les backtests publiés vont dans le sens attendu (Newfound et ReSolve, plus les études académiques sur le 60/40 levé). Sur le long terme, un 60/40 à levier 1,5 domine le 60/40 en rendement, pour un drawdown comparable à celui d'un 100 % actions. Et l'ajout d'un étage trend améliore nettement les pires trajectoires, exactement la géométrie que cherche un rentier ([[sequence-des-rendements]]).
:::
...
::: astuce Tester la pile avant de l'acheter
La brique se teste avant de s'acheter. Il faut pour cela un simulateur dont le catalogue contient des historiques reconstruits de fonds efficient core et de stratégies empilées actions plus trend (pofo en embarque, calibrés sur les indices de référence). Composez votre plan actuel contre sa version « cœur levé plus trend libéré », puis lisez les trois mêmes juges que d'habitude. Le central doit monter un peu. Le stress 1966/1973 doit s'améliorer nettement. Le drawdown réel maximal dit le prix psychologique ([[lire-un-fan-chart]]).
:::

::: exemple Libérer 25 % de diversification sans vendre une action
Plan : 1 M€, 38 000 €/an, 60 % actions / 40 % obligations, 45 ans. Version empilée : 67 % en fonds 90/60 (soit 60 d'actions et 40 d'obligations en exposition), 18 % trend, 10 % or, 5 % cash. Exposition totale ≈ 133 %, dont un étage défensif de 33 % qui n'existait pas. Lecture type au simulateur. Le central passe de 3,7 à 3,9 % (la prime empilée, nette du cash). Le stress passe de 5,4 à 4,6 % (le trend et l'or travaillent les régimes longs sans avoir désarmé les actions). Le pire drawdown réel passe de −34 % à −29 %. Mais l'année 2022 rejouée fait −21 % contre −17 %, car le levier obligataire pique quand tout baisse ensemble. La clause écrite au plan : « levier global plafonné à 1,35 ; l'étage empilé est jugé net du taux court ; si le fonds cœur ferme ou change de politique, retour au 60/40 simple sous un mois ». Sans accepter la ligne 2022, ne signez pas les deux autres.
:::
