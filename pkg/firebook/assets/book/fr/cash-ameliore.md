...
| Accès | en bourse, tous les jours, sans fenêtre | fenêtre de commercialisation, puis fermeture |
| Sortie anticipée | au prix du marché, quand vous voulez | à la valeur liquidative, parfois avec pénalité |
| Nombre de lignes | plusieurs centaines | quelques dizaines |

Deux conséquences. L'écart de frais, sur un horizon de quatre ans, mange une part considérable de l'avantage annoncé : un rendement actuariel de 4 % amputé de 1,5 % de frais totaux n'est plus le même placement. Et la différence de contenu n'est pas un détail de style, elle change la nature du risque, puisqu'un panier de haut rendement perd des émetteurs en route quand un panier de qualité n'en perd presque pas.

**Pourquoi le fonds daté existe encore.** À lire le tableau, l'ETF gagne sur toute la ligne, et la question devient légitime : pourquoi continuer à vendre l'autre ? Parce que le tableau compare les produits nus, et qu'un placement ne se détient jamais nu. Deux raisons font vivre le fonds daté, et l'une comme l'autre peut emporter la décision.

**L'enveloppe d'abord**, et c'est la principale. Les ETF à millésimes se logent presque tous sur un compte-titres : les assureurs les référencent au compte-gouttes, quelques contrats à peine en France. Or l'argent prudent d'un ménage français dort le plus souvent en assurance-vie, où la fiscalité reste plus douce qu'au compte-titres ([[enveloppes-francaises]], [[flat-tax-et-imposition]]). La comparaison honnête n'oppose donc pas deux fonds, elle oppose deux montages : l'ETF sur compte-titres, net de son imposition, contre le fonds daté en assurance-vie, net des frais du contrat et de la sienne. Les deux écarts jouent en sens contraire, un point et demi de frais en trop d'un côté, une imposition plus légère de l'autre, et le calcul se fait cas par cas, pas en règle générale. Sur un horizon court, les frais gagnent presque toujours ; l'écart ne se resserre que si le contrat a passé huit ans et porte une plus-value substantielle. Et pour l'argent déjà logé dans un vieux contrat, la question ne se pose même pas : en sortir pour acheter l'ETF, c'est cristalliser l'impôt.

**Le segment de crédit ensuite.** Les gammes cotées en euro s'arrêtent à la catégorie investissement, l'investment grade des brochures : il n'existe pas de millésime à haut rendement, alors que la plupart des fonds datés maison vivent précisément de ce segment. Du haut rendement à échéance fixe, un choix défendable pour une petite poche et un horizon connu, n'existe donc pas en version cotée sur le marché européen. Le prix est celui du segment : des défauts en cours de route, qui s'ajoutent aux frais.
...
Pour un pont de plusieurs années, on empile un millésime par année à financer, dimensionné sur la dépense de cette année-là, diminuée des revenus déjà acquis. C'est une échelle d'obligations qu'on achète en quatre ordres de bourse au lieu de la construire titre par titre, avec la diversification en prime, plusieurs centaines d'émetteurs contre les cinq ou six lignes qu'un particulier tient en direct.

Trois détails d'exécution que les brochures passent sous silence. **La dernière année ne rapporte pas ce que le millésime affichait** : à mesure que les obligations arrivent à échéance, le fonds encaisse et garde le produit en instruments monétaires, si bien que son rendement glisse vers le taux court pendant les derniers mois. Sur un millésime acheté à quatre ans, cela rogne une fraction du rendement annoncé, et cette fraction est d'autant plus grande que le taux court est bas. **La sortie est une liquidation** : à la date prévue, le fonds est radié de la cote et vous verse le produit en espèces, comme une obligation remboursée. Rien n'est reconduit, et sur un compte-titres cela fait un événement fiscal unique, à anticiper si la plus-value est grosse ([[flat-tax-et-imposition]]). **Capitalisant ou distribuant** enfin, selon l'usage : le distribuant verse les coupons en cours de route, ce qui colle à un besoin de revenu régulier, le capitalisant les réinvestit et ne se solde qu'à la fin, ce qui colle à une dépense unique et repousse l'imposition.

Reste à vérifier ce que vous achetez vraiment. La taille du millésime, car les échéances lointaines sont parfois maigres et se paient au carnet d'ordres. Et l'indice suivi, car les gammes en euro répliquent des indices filtrés selon des critères extra-financiers, ce qui restreint l'univers d'émetteurs sans que le nom du fonds le dise.
...
- Version ETF plutôt que fonds daté maison, hors assurance-vie et hors haut rendement : dix fois moins de frais, du crédit de qualité, et l'achat comme la vente en bourse. Le fonds maison garde deux terrains, l'enveloppe où les millésimes cotés sont rarement référencés, et le haut rendement daté qui n'existe pas en ETF européen. Trois détails d'exécution à connaître, le rendement de la dernière année qui glisse vers le taux court, la liquidation en espèces qui fait un événement fiscal unique, et le choix capitalisant ou distribuant selon que la dépense est ponctuelle ou régulière.
