...
- Version ETF plutôt que fonds daté maison : dix fois moins de frais, du crédit de qualité au lieu du haut rendement, et l'achat comme la vente en bourse. Trois détails d'exécution à connaître, le rendement de la dernière année qui glisse vers le taux court, la liquidation en espèces qui fait un événement fiscal unique, et le choix capitalisant ou distribuant selon que la dépense est ponctuelle ou régulière.
