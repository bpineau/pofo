...
La même analyse, poussée année par année plutôt que par tranches de dix ans : la part de l'issue finale que le rendement de chaque année de retraite explique à lui seul. Les deux premières années en portent un cinquième, la première décennie 70 %, les vingt dernières 6 % à elles toutes. Mesure faite sur le modèle central, avec un retrait rigide de 4 % sur quarante ans. Et comme ce modèle tire les années indépendamment, il sous-estime plutôt qu'il n'exagère.
:::
