...
Les tests se font en vingt minutes dans pofo (§04 pour les revenus vécus, solveur pour les seuils) et éliminent typiquement une ou deux familles : la décision se simplifie déjà.
...
La séance finale dans pofo ([[utiliser-la-page-fire]]), une heure au plus : configurez la règle candidate avec **vos** paramètres (pas ceux d'un article américain) ; validez la ruine dans le faisceau (acceptable au central, tolérable au broad-sample, survivable en décennie perdue, [[historique-vs-parametrique]]) ; lisez la §04 sur le pire quartile (la vie vécue est-elle au-dessus du plancher, pendant des durées tenables ?) ; comparez en A/B avec la deuxième finaliste (la frontière §06 les positionne) ; puis **écrivez** : la règle, ses paramètres, ses seuils, la date de revue, la règle de la phase suivante, et les conditions de changement (on ne change pas de règle en cours de krach : on le décide à froid, à la revue annuelle, pour des raisons écrites). Ce document d'une page est le produit final de toute la partie IV ([[construire-son-plan]] l'intègre au plan complet).

::: exemple Le processus complet, sur un vrai cas
Claire (51 ans) et Idris (53 ans) : 1,7 M€, plancher 45 000 €, confort 58 000 €, pensions 24 000 €/an dans 13 ans. Étape 1 : phase à découvert de 13 ans, plancher financé à 100 % par le portefeuille puis à 53 % par les pensions. Étape 2, admissibilité : le fixe à 3,4 % passe (58 000/1,7 M) ; le VPW échoue au test de perte **avant** pension (revenu −50 % actions : 41 000 € < plancher) mais passerait après ; l'ABW passe (g décoté : revenu du pire quartile 47 500 €) ; le corridor passe de justesse. Étape 3, tempérament : Claire veut la stabilité, Idris la justesse ; gouvernance : Claire exécutera. Étape 4, l'hybride par phases s'impose : guardrails par risque pendant le découvert (seuils dimensionnés au solveur : coupe si ruine centrale > 13 %, hausse si < 1 %, ajustements ±10 %, plancher de coupe 78 %), puis VPW sur le résiduel une fois les pensions au plancher. Étape 5 : ruine centrale 4 %, broad-sample 9 % (échecs tardifs, adossés), pire quartile §04 : deux coupes maximum, jamais sous 46 400 € : signé, écrit, daté. Durée totale du processus : deux soirées : dont une de conversation, pas de calcul : c'est la bonne proportion.
:::
