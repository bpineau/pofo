...
Ces tests se font en vingt minutes dans un simulateur, la §04 pour les revenus vécus et le solveur pour les seuils. Ils éliminent typiquement une ou deux familles, et la décision se simplifie déjà.
...
La séance finale tient en une heure, dans le simulateur FIRE de pofo ([[utiliser-la-page-fire]]). Configurez la règle candidate avec **vos** paramètres, pas ceux d'un article américain. Validez la ruine dans le faisceau : acceptable au central, tolérable au broad-sample, soutenable en décennie perdue ([[historique-vs-parametrique]]). Lisez la §04 sur le pire quartile, pour vérifier que la vie vécue reste au-dessus du plancher pendant des durées tenables. Comparez en A/B avec la deuxième finaliste, que la frontière §06 positionne. Puis **écrivez** l'essentiel : la règle, ses paramètres, ses seuils, la date de revue, la règle de la phase suivante et les conditions de changement. On ne change pas de règle en cours de krach ; on le décide à froid, à la revue annuelle, pour des raisons écrites. Ce document d'une page est le produit final de toute la partie IV, que [[construire-son-plan]] intègre au plan complet.
