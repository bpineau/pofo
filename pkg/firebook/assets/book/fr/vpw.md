...
- **Le retrait amorti sur l'horizon restant** (ABW/TPAW). C'est l'annuité inversée intégrale : pourcentage croissant, horizon exact, flux futurs actualisés et rendements attendus courants, ancre de valorisation comprise si l'outil en tient une. C'est le VPW moderne, celui de TPAW Planner ([[amortissement-abw]]).
