...
- Mise en œuvre : une cellule de tableur ; sur la page FIRE, la forme aboutie est ABW + ancre CAPE (amortissement au rendement impliqué par les valorisations) ; en douceur, conditionner au CAPE le taux initial et les grandes révisions d'un retrait fixe amendé.
