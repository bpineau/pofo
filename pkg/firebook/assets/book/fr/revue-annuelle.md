...
Le plan est écrit ([[construire-son-plan]]). Reste à le faire vivre quarante ans. Le rythme de croisière de ce livre tient en une phrase : une vraie séance par an, **rien** entre deux (sauf franchissement d'un seuil écrit, [[quand-s-inquieter]]). La revue annuelle est le seul rendez-vous où le plan a le droit de changer. C'est sa force. Toutes les décisions s'y prennent à froid, à date fixe, à deux, loin des gros titres. Voilà pourquoi elle mérite une procédure complète plutôt qu'une intention vague.

Ce chapitre est cette procédure. Vous y trouverez la check-list intégrale en sept blocs : les chiffres, la règle exécutée, le portefeuille, le fiscal, les protections, le couple et la gouvernance, le non-financier. Pour chaque bloc, les gestes exacts et la durée honnête, deux à trois heures au total (le rentier qui y passe ses week-ends a un problème d'un autre chapitre, [[psychologie-du-retrait]]). Vous y trouverez aussi les pièges de la revue elle-même, le bricolage déguisé en rigueur et la renégociation annuelle de ce qui était réglé. Et le calendrier, car janvier n'est pas choisi au hasard.

::: cle La doctrine de la revue
La revue **constate** et **exécute**. Elle ne reconçoit pas. Le plan a été conçu une fois, en faisceau, à froid ([[construire-son-plan]]). La revue, elle, vérifie que la réalité reste dans les clous. Elle applique les règles écrites qui se déclenchent. Elle met à jour les chiffres qui vivent, dépenses, pension, fiscalité. Et elle **ne rouvre** une décision de conception que sur fait nouveau **majeur**, la clause anti-goalposts en tête ([[une-annee-de-plus]]). Le test d'une bonne revue : si rien d'anormal ne s'est passé, elle ne change presque rien. C'est un succès, pas une déception.
:::

## Le calendrier, et la préparation

**La date** est fixe, écrite au plan. Début janvier a trois vertus. L'année fiscale est close, donc les chiffres réels sont disponibles. L'indexation du retrait se cale sur l'inflation constatée ([[retrait-fixe-bengen]]). Et l'arbitrage barème/PFU de la déclaration se prépare ([[flat-tax-et-imposition]]). **La préparation** prend une heure, avant la séance. Exporter les soldes par enveloppe. Réunir les dépenses réelles de l'année, via l'agrégateur ou les relevés. Sortir le relevé info-retraite si l'année a validé des trimestres ([[retraite-legale]]). Et relire **la page** du plan, car la séance se fait document en main.
...
- Une vraie séance par an, à date fixe (janvier, pour le fiscal et l'indexation), à **deux**, document en main. Rien entre deux hors seuils écrits : la revue constate et exécute, elle ne reconçoit pas.
- Les sept blocs : chiffres constatés (dont le taux courant sur son échelle), règle exécutée (l'indexation, les seuils re-simulés, la confirmation sur deux revues), portefeuille (bandes, tente, hygiène, jamais de vue de marché), fiscal (le programme de lissage de l'année, la veille datée), protections (buffer, échelle, assurances, marges entretenues), couple (le quiz inversé), et la ligne non financière.
- La date du contrôle n'est pas neutre dès que la règle a des seuils : à trajectoire identique, changer le seul mois de la revue déplace l'année la plus maigre de 10 % en médiane. On la désamorce en contrôlant plus souvent avec des mouvements rééchelonnés, ou par l'hystérésis, jamais en espérant que le calendrier soit bienveillant.
- Une revue annuelle n'est pas un retrait annuel : la décision est annuelle, le virement reste mensuel. Sortir douze mois de cash en janvier coûte environ 3,7 % de capital final sur trente ans et double les trajectoires ruinées.
- Durée honnête, de 1 h 30 à 3 h. Le journal de trois lignes par an en est le sous-produit précieux. Il révèle aussi les dérives, car la revue-bricolage se voit dans son propre journal.
- Les pièges du rituel : bricolage, renégociation, procès de l'année, revue sautée des années calmes. Son prix plancher reste de 90 minutes, toujours.
