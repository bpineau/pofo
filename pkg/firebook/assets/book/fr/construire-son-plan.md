...
On reprend la séance type de [[utiliser-la-page-fire]], en recette finale, avec les entrées auditées saisies. La lecture se fait en faisceau (central acceptable à **votre** seuil [[ruine-et-probabilites]], broad-sample tolérable avec des échecs analysés [[historique-vs-parametrique]], millésimes 1966/2000 traversés, décennie perdue survivable). La §04 examine le pire quartile (la vie vécue au-dessus du plancher, en profondeur et en durée). La §03 montre l'exposition à la séquence, adoucie par vos protections. Les sensibilités tranchent (±10 % dépenses, ±0,5 pt rendement, pension ±2 ans, la décision survit-elle ?). Et le solveur §09 sert de contre-épreuve (si un levier bon marché traîne, le prendre maintenant). Un plan qui passe cette recette est un plan. Les suivants échouent à un test et retournent à leur étape. C'est le fonctionnement normal du chantier.
