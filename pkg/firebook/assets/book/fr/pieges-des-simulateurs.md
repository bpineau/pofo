...
- Le dernier piège est l'utilisateur : aucune machine n'empêche le p-hacking de scénarios ; la parade est procédurale (entrées auditées, multi-modèles, décision sur les modèles durs, revue annuelle).
...
- Anarkulova, Cederburg, O'Doherty & Sias (2023) : l'ampleur chiffrée du piège n° 1 ([[anarkulova-cederburg]]).
