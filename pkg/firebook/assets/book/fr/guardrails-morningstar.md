...
- Dans la page FIRE : la case « Risk-based guardrails » (la règle en natif, bande sur le taux sûr de l'horizon restant), le solveur §09 (dimensionner les seuils), la §04 (le pire quartile vécu), la frontière §06, où la famille apparaît deux fois, capteur 2006 et capteur par risque ([[utiliser-la-page-fire]]).
