...
La proposition de Kitces et Tharp (développée sur kitces.com et industrialisée dans des outils comme Income Lab) : **surveiller directement la probabilité de succès du plan complet**, recalculée avec un simulateur, et poser les garde-fous dessus. L'architecture type :
...
- Version exécutable avec pofo : trois seuils de ruine écrits (cible ~5 %, coupe >12-15 %, hausse <1 %), ±10 % jamais sous le plancher, revue annuelle, confirmation sur deux revues : et chaque seuil VÉRIFIÉ au solveur dans les deux sens.
...
- Guyton & Klinger (2006) pour l'ancêtre, et ERN Parts 9-11 pour la critique qui a rendu ces refontes nécessaires ([[serie-ern]], [[guyton-klinger]]).
