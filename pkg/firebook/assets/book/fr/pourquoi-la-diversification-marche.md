...
- En décumulation, l'effet est démultiplié. La diversification travaille la queue gauche et le risque de séquence, donc le SWR, même quand elle abaisse la médiane. On diversifie pour le percentile 5.
...
- Le portefeuille diversifié contient toujours une ligne décevante, par construction. Qui ne l'accepte pas par écrit finira par vendre la brique la veille du jour où elle allait servir.
