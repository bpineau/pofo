...
Cet article la traite à fond : la mécanique (le crédit immobilier à l'envers, re-coté chaque année), ses fondations théoriques, les quatre paramètres qui la personnalisent (rendement, horizon, legs, pente), ses pathologies, la comparaison finale avec les guardrails, et son implémentation native dans pofo.
