...
**3. La coupe réversible bornée (le standard).** −10 à −15 % du confort, déclenchée par un seuil (drawdown > 20 % ou taux courant > X %, [[quand-s-inquieter]]), levée au retour sous le seuil. C'est le curseur « Cut in downturns » et le cœur des guardrails ([[guyton-klinger]], [[guardrails-morningstar]]). Ce sont les 0,3-0,5 point du chiffrage, à condition que le plancher la rende tenable (voir ci-dessous).
...
Deux lucidités pour finir. D'abord, la flexibilité **se vit**. La ruine évitée s'achète en années de dépenses réduites, et l'asymétrie psychologique est documentée : la perte pèse double ([[psychologie-du-retrait]]). Couper de 12 % pendant quatre ans, ce n'est pas « rien ». C'est quatre ans de renoncements comptés. La §04 (« The spending you actually live ») existe précisément pour regarder ce prix avant de signer : la distribution du niveau de vie dans le pire quartile, sa profondeur et sa **durée**. C'est le critère discriminant de toutes les règles flexibles ([[panorama-strategies-retrait]], [[utiliser-la-page-fire]]).

Ensuite, la condition qui sépare la flexibilité qui compte de celle qui n'existe pas : l'**écriture**. La flexibilité-intention (« on fera attention si ça va mal ») a trois défauts fatals. Elle se déclenche trop tard, par déni des premières années de baisse. Elle se déclenche trop peu, car les coupes improvisées sont symboliques, l'abonnement et non le budget. Et elle s'improvise dans la peur, les pires décisions du répertoire ([[psychologie-du-retrait]]). La flexibilité-règle (seuil écrit, ampleur écrite, levée écrite, [[quand-s-inquieter]], [[construire-son-plan]]) se déclenche à temps, à la bonne dose, et sans débat conjugal en pleine tempête ([[couple-et-famille]]). C'est aussi la seule que le simulateur peut créditer. Quand il affiche la ruine d'un plan « avec flex », il simule une règle appliquée mécaniquement. Si votre flexibilité réelle est une intention, la vraie colonne de votre plan est celle **sans** flex : lisez-la.

::: exemple Le même plan, trois honnêtetés
Plan : 1,4 M€, confort 52 000 € (3,7 %), 45 ans.

Version « phrase magique » : taux poussé à 4,3 % (60 000 €) « parce qu'on sera flexibles ». La simulation honnête (coupes réalistes bornées) affiche 11 % de ruine centrale, et la §04 montre le pire quartile à −25 % pendant 9 ans. La flexibilité invoquée exigerait ce qu'elle ne peut pas tenir.
...
- La flexibilité réaliste vaut 0,3-0,5 point de taux de retrait, précieuse et réelle, et dix fois moins que ce que la phrase magique lui fait porter. Le mécanisme : les mauvaises passes durent 10-15 ans, les coupes se tiennent 3-5 ans, la durée bat la profondeur.
...
- La flexibilité se vit (la §04 montre le prix, profondeur et durée du pire quartile) et ne compte qu'**écrite** (seuil, ampleur, levée) : l'intention vaut zéro dans le simulateur et pire dans la tempête.
