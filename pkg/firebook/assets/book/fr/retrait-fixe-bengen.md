...
**Quand : la fréquence du prélèvement.** Annuel en début d'année (la convention des études), mensuel (la vraie vie, la case « Monthly withdrawals ») : l'écart est faible (le mensuel lisse un peu le point d'entrée des ventes, quelques dixièmes de point sur la ruine) mais le mensuel a une vertu de gouvernance. Il transforme le retrait en « salaire » et évite la tentation de décaler la grosse vente annuelle en regardant le marché, qui est du market timing déguisé.

**Quelle inflation : l'indice.** La règle canonique indexe sur l'IPC national ; votre inflation personnelle peut en diverger durablement (santé, dépendance, la dérive réglable, [[suivre-inflation]], [[depenses-en-retraite]]). Indexer sur l'IPC en laissant la dérive santé non financée est l'angle mort le plus courant des plans « à la Bengen » de plus de 30 ans.
