...
Tout ce livre raisonne en euros constants. Les dépenses d'un rentier sont réelles, son plancher est réel, sa ruine se joue en réel ([[inflation-et-taux-de-retrait]]). Or presque tous ses actifs promettent du nominal. Une obligation classique qui sert 3 % pendant que l'inflation fait 5 % appauvrit son détenteur avec une régularité contractuelle.
...
Voici le résultat qui a fait le tour de la communauté (Allan Roth, 2022, puis Morningstar et les Bogleheads). Avec des taux réels TIPS autour de 2 %, une échelle de TIPS de 30 ans (un barreau par année de dépenses, chacun détenu à échéance) finançait un retrait initial d'environ 4,5 % par an, indexé sur l'inflation, garanti par l'État américain, pendant 30 ans. C'est-à-dire plus que la règle des 4 %, sans aucun risque de marché ni de séquence. C'est le taux de retrait que l'on espérait du portefeuille actions, atteint par un simple adossement, tant que les taux réels le permettent. La version euro est moins généreuse (taux réels ~1 %, l'échelle de 30 ans finance ~3,9 %) et moins praticable en direct (voir plus bas).

Mais le point conceptuel est immense. Le taux réel du marché des linkers est le vrai taux sans risque du rentier, l'étalon contre lequel tout portefeuille risqué doit se justifier ([[rendements-attendus]]).

Quand l'échelle garantit 3,9 % et que votre plan risqué vise 3,6 % « avec 8 % de ruine », la question « pourquoi prendre le risque ? » mérite une vraie réponse. Les bonnes réponses existent : l'horizon FIRE dépasse 30 ans, et l'échelle n'a ni croissance ni legs ni flexibilité à la hausse. Mais cette réponse doit être donnée, pas éludée.

Restent les limites. Le réinvestissement est nul, car l'échelle se consomme. Le risque de longévité au-delà du dernier barreau se couvre en rente ([[rentes-et-annuites]]). Et il y a la fenêtre des taux réels, car à 0 % réel, l'échelle 30 ans ne finance plus que ~3,3 %.
:::
...
- Le résultat à connaître, l'échelle de linkers garantit en réel des taux comparables à la règle des 4 % quand les taux réels sont ~1-2 % (4,5 % US en 2023-24, ~3,9 % euro). Elle est moins praticable en direct pour un Français (ETF courts roulés, offre à suivre), mais l'étalon conceptuel demeure.
...
- Allan Roth, « The 4% Rule Just Became a Whole Lot Easier » (2022) et les analyses TIPS-ladder de Morningstar : le résultat de l'échelle, dans le texte.
