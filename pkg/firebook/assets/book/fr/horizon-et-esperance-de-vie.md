...
Et pour la queue de longévité extrême (centenaire), le bon outil n'est pas le portefeuille. C'est l'actif qui paie **tant que** vous vivez, exactement calibré sur le risque. Votre pension de retraite légale est déjà une rente viagère indexée ([[retraite-legale]]). Une annuité complémentaire achetée tard (75-80 ans, quand la mutualisation joue à plein) en est le complément technique ([[rentes-et-annuites]]). L'arbitrage se teste en simulation, en convertissant une fraction du capital en rente à une date choisie, puis en comparant les deux profils de risque. La rente fait souvent remonter la probabilité de ruine **moyenne**, car on convertit des actifs de croissance en revenu plancher. Mais elle écrase la queue « vivant, ruiné, 95 ans », précisément le scénario qu'on cherche à éliminer.
