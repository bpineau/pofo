...
**Oublier que le futur peut être pire que toutes les prévisions.** Les CMA sont des espérances centrales : aucune ne « contient » 1929, le Japon 1990 ou une guerre. C'est le rôle des autres colonnes de pofo (stress de séquence, décennie perdue, broad-sample) et des protections structurelles ([[portefeuilles-tous-temps]], [[flexibilite-realite]]). L'espérance prospective calibre le centre ; elle ne remplace ni les queues ni les marges.
