...
Premièrement, le plan appartient **aux deux**. Un FIRE imposé ne tient pas. Un conjoint « embarqué » dans une frugalité qu'il n'a pas choisie, c'est une dette qui se paie avec intérêts, au mieux en tensions, au pire en rupture. Et la rupture, c'est la ruine. Le rythme du moins pressé est le rythme du projet.

Deuxièmement, le plan doit être **exécutable par chacun**. Si un seul des deux comprend les enveloppes, la règle de retrait et les seuils, le plan a un point de défaillance unique. La page écrite, la lettre d'instructions et une revue annuelle **faite à deux** sont des exigences de conception, pas des politesses ([[construire-son-plan]]).
:::
...
Les outils sont prosaïques et reviennent dans tous les récits. On délimite des **territoires** : chacun ses pièces, ses créneaux, ses activités, et la journée type se négocie comme une colocation bienveillante. On garde des **vies sociales distinctes** en plus de la vie commune, car le conjoint ne peut pas être toute l'infrastructure ([[sens-et-identite]]). On mène des **projets séparés** en plus des projets communs, parce que l'ennui à deux pèse plus lourd que l'ennui seul. Reste un point de calendrier. La première année, celle où les **deux** traversent leur convalescence en même temps, est la plus délicate ([[temoignages-fire]]). Le savoir d'avance désamorce la moitié des frayeurs : « ce n'est pas nous, c'est la phase ».

::: attention La gouvernance : le problème du gestionnaire unique
Dans la plupart des ménages du mouvement, l'un des deux a construit le plan : enveloppes, allocation, règle, seuils. L'autre fait confiance. La configuration est confortable, et **dangereuse**. Au décès ou à l'incapacité du gestionnaire ([[sante-et-protection-sociale]], la prévoyance), l'autre hérite d'un système qu'il ne sait pas piloter, au pire moment, entouré de vendeurs ravis.

Quatre exigences minimales, non négociables. Un **plan sur une page** lisible par l'autre, avec la règle, les montants, les seuils et les « ne jamais faire » ([[construire-son-plan]]). Une **lettre d'instructions** qui recense comptes, accès et contacts ([[succession-et-transmission]]). Une **revue annuelle à deux**, deux heures par an, au terme de laquelle le non-gestionnaire doit pouvoir dire « je sais où on en est, et quoi faire si » : c'est là l'objectif pédagogique de la revue ([[revue-annuelle]]). Enfin, un plan **volontairement** simplifié à la mesure de son pire exécutant. Une règle Vanguard bornée que les deux savent appliquer bat une usine ABW optimale que seul l'un des deux fait tourner ([[choisir-sa-strategie]]). La gouvernance est un critère de premier rang, et le voici incarné.

Testez-vous. Si votre conjoint devait prendre la main lundi, que se passerait-il ? Si la réponse est « il ou elle appellerait le banquier », le plan a un trou.
:::

## Le divorce : la lucidité obligatoire

Personne ne planifie son divorce, et un livre de gestion des risques n'a pas le droit de l'omettre. C'est le scénario qui divise le capital par deux et gonfle les besoins, avec deux logements et deux vies. Financièrement, aucun krach de l'histoire ne fait aussi mal, car ce capital-là ne revient jamais.
...
Leur **coût** est datable et provisionnable. Les études supérieures pèsent de 10 à 25 k€ par an pendant 3 à 5 ans par enfant, à des dates connues quinze ans à l'avance : c'est le cas d'école de l'échelle obligataire ([[echelle-obligataire]], [[combien-il-vous-faut]]).
...
**Les parents vieillissants** sont le sujet que le FIRE rencontre plus souvent que les autres. Le temps libre fait de vous l'**aidant naturel** désigné de la fratrie. C'est une richesse : le temps donné, la présence, cités parmi les plus beaux bilans du corpus. C'est aussi un risque à nommer. L'aide peut devenir un emploi à plein temps qu'on n'a pas choisi. Elle a un coût, car l'obligation alimentaire existe en droit français : l'EHPAD d'un parent insolvable peut se retourner vers les enfants, si bien que le provisionnement vu au chapitre santé vaut aussi en amont ([[sante-et-protection-sociale]]). Elle pose enfin une question d'équité, car celui qui donne son temps n'a pas à être en plus le seul à payer. Ces conversations de fratrie se tiennent tôt. Le plan peut porter une ligne « soutien famille », car mieux vaut une provision nommée qu'une surprise récurrente.

::: exemple La revue annuelle à deux, dans la vraie vie
Chez Nadia et Marc ([[retraite-legale]]), la revue de janvier dure deux heures et suit un ordre rodé.

1) Marc, le gestionnaire, déroule la page du plan. Taux courant à 3,7 %, tous les voyants verts, rééquilibrage fait par les retraits. Dix minutes.

2) Vient le quiz inversé. Nadia explique à **Marc** ce qu'elle ferait s'il était hospitalisé demain : la lettre d'instructions, le virement mensuel, « on ne vend rien, on n'appelle personne ». Quinze minutes, et c'est le vrai livrable.

3) Le budget à deux. Le poste voyages est sous-consommé, encore une fois, et la décision tombe : réservation **obligatoire** avant mars ([[psychologie-du-retrait]]).

4) La ligne famille. Les études de Léo arrivent dans 4 ans et les barreaux correspondants de l'échelle sont provisionnés. Le père de Marc décline, alors une conversation de fratrie est programmée.

5) La ligne non financière, les quatre chantiers de chacun ([[sens-et-identite]]). Nadia va bien, Marc s'ennuie ; il ressort sa liste d'hypothèses.

Deux heures par an, et le plan, le couple et la famille tiennent dans la même boucle. C'est toute la gouvernance qu'un bon plan exige.
:::
