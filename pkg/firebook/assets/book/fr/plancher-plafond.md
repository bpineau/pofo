...
Entre le montant fixe qui ignore les marchés ([[retrait-fixe-bengen]]) et le pourcentage qui les épouse ([[pourcentage-fixe]]), il existe une troisième voie d'une simplicité désarmante. On suit le pourcentage, mais on borne le mouvement. C'est la famille plancher-plafond. Sa version industrielle est la règle de dépense dynamique de Vanguard (« dynamic spending ») : chaque année, on vise X % du portefeuille courant, mais on interdit au revenu réel de monter de plus de +5 % ou de descendre de plus de −2,5 % par rapport à l'an dernier.
...
::: admin Mode d'emploi
- **Deux références, à ne surtout pas mélanger.** La cible s'applique au **portefeuille courant** : w × portefeuille du jour, avec un w fixé au départ et jamais révisé. Les bornes, elles, s'appliquent au **retrait réellement servi l'an dernier**, et non à la cible de l'an dernier ni au retrait initial. C'est ce qui donne à la règle sa mémoire courte et son absence d'ancre : après dix ans, plus rien dans le calcul ne se souvient du jour du départ.
- **Indexation.** Tout se raisonne en euros constants : on réindexe d'abord sur l'inflation le retrait servi l'an dernier, puis on lui applique +5 % / −2,5 %. D'où une conséquence qui explique le succès de la règle : avec 2 à 3 % d'inflation, la coupe maximale autorisée vaut entre −0,6 % et +0,4 % **en euros courants**. Le relevé bancaire ne bouge pratiquement pas pendant que le pouvoir d'achat recule de 2,5 % par an. C'est délibéré ([[psychologie-du-retrait]]).
- **Fréquence.** Annuelle. C'est la famille où la cadence compte le moins, puisque le lissage vient des bornes et non de la date.
- **Les seuils sont un point d'une grille, pas une constante de la nature.** Vanguard a balayé les couples possibles en arbitrant taux de succès à 35 ans contre stabilité du revenu, et retenu celui-ci, qui tient environ 85 % de survie à 35 ans ; sa publication de 2020 affiche un défaut plus timide encore, +5 / −1,5. Déplacez donc les bornes sans scrupule : (+4 / −2) pour un budget rigide, (+6 / −4) pour un budget élastique. L'asymétrie, elle, doit rester : elle traduit un fait mesuré, une baisse de revenu pèse plus lourd qu'une hausse de même ampleur ne rapporte ([[psychologie-du-retrait]]).
- **Plancher.** Aucun nativement, et c'est le seul vrai défaut de la règle : sa borne basse est une **vitesse**, pas un niveau, donc rien n'arrête la descente si le régime hostile dure. Le test d'admissibilité en tient lieu : (1 − borne basse) puissance n doit rester au-dessus de votre plancher réel, pour un n de la durée d'un vrai régime hostile, une vingtaine d'années et non six.
- **De tête.** Retrait servi = w × portefeuille, écrêté dans l'intervalle [servi de l'an dernier × 0,975 ; servi de l'an dernier × 1,05].
:::
...
Le prix se lit dans la même table. Aux années 3 et 4, on prélève 4,8 à 5,3 % d'un portefeuille amputé : la descente plafonnée « emprunte » au capital pendant les crises. Dans les scénarios ordinaires, le portefeuille rembourse à la reprise. Dans un régime vraiment long et hostile ([[regimes-de-marche]]), l'emprunt s'accumule et la ruine redevient possible. C'est le point clé à comprendre. Les bornes revendent une partie de la garantie anti-ruine du pourcentage pour acheter de la stabilité. La règle Vanguard se place donc entre le fixe et le pourcentage sur la frontière ([[panorama-strategies-retrait]]). Sa ruine, faible mais non nulle, est un vrai chiffre, comparable à celui du fixe. C'est là toute sa différence avec le 0 % creux du pourcentage pur, ou avec le chiffre incomparable du Guyton-Klinger sans plancher ([[guyton-klinger]]).
