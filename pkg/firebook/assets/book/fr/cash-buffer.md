...
**Mais le financement du matelas a un coût symétrique.** Les 2-3 ans de dépenses du matelas, soit 7-10 % d'un plan à 3,5 %, rapportent ~0-1 % réel au lieu des 3-5 % du portefeuille. C'est un manque à gagner de ~0,25-0,4 % par an sur tout le plan, payé chaque année, y compris les trente années où aucun krach ne mord. La simulation fait les comptes des deux côtés. ERN (volet 12, « Cash Cushion Concerns ») trouve le net légèrement négatif pour les buffers statiques naïfs. Les études plus favorables, avec des règles intelligentes, trouvent un net légèrement positif. Le test décisif est un balayage. On rejoue le même plan avec un matelas de 0 à 10 ans, tout le reste égal par ailleurs, et l'on trace le résultat. Selon les plans, la courbe de ruine sort plate ou avec un optimum mou vers 2-4 ans. Encore faut-il la lire sur deux sorties et non sur une seule. La ruine bouge à peine, tandis que la richesse finale médiane baisse à chaque année de matelas ajoutée. C'est le vrai arbitrage du matelas, une assurance payée en patrimoine terminal plutôt qu'en probabilité de survie. Le verdict quantitatif honnête tient en une ligne. Le buffer bien géré est à peu près gratuit, mais il n'est presque jamais transformateur.
...
::: attention La convention de financement décide du verdict
Avant de comparer deux chiffres de ruine, une question de méthode. Le matelas est-il prélevé sur le capital de départ, ou ajouté par-dessus ? La seule convention honnête est le prélèvement. « 3 ans de buffer » sur un plan à 1,5 M€ signifie alors ~150 k€ au matelas et 1,35 M€ au moteur, la richesse totale restant la somme des deux. C'est cette convention qui fait payer au matelas son coût d'opportunité, et c'est pourquoi la courbe de ruine peut remonter quand le matelas grossit. Ajouter le matelas au-dessus du capital revient au contraire à comparer deux plans de tailles différentes, ce qui rend le buffer gratuit par construction et flatte toutes ses versions. Deux hypothèses doivent en outre être explicites. Le rendement réel du matelas d'abord, qui n'est pas zéro pour un fonds euros net (~0,5-1 %) et déplace le verdict. L'année d'arrêt de la recharge ensuite, car un matelas limité à la première décennie épouse la concentration du risque de séquence ([[sequence-des-rendements]]).
:::
...
- Dans pofo : le balayage de la taille du matelas et la distribution des années passées sous l'eau, pour dimensionner sur vos propres traversées ([[utiliser-la-page-fire]]).
