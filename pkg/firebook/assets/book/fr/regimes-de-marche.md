...
La conséquence directe des régimes pour la simulation a déjà été posée ([[rendre-monte-carlo-pertinent]]). Résumons-la du point de vue des saisons, car c'est ici qu'elle se justifie.
...
- Dans ce livre : [[la-machine-pofo]], pour l'implémentation du stress de séquence, du broad-sample et de la décennie perdue dans pofo.
