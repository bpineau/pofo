...
Un fan chart ne montre pas des futurs. Il montre, pour chaque date, la **distribution** des états possibles à cette date. La bande à 90 % de l'année 20 dit « à l'année 20, 90 % des trajectoires simulées sont dans cette tranche ». Elle ne dit rien sur la façon dont une trajectoire donnée y est arrivée, ni où elle ira ensuite. Le cône est une pile de coupes transversales, pas un faisceau de chemins ; les vrais chemins, eux, traversent les bandes en zigzag toute leur vie. Toutes les erreurs de lecture découlent de la confusion entre ces deux objets.
:::
...
**La ligne de zéro et l'écrêtage du haut.** Le zéro est la seule frontière absolue du graphique : la ruine ([[ruine-et-probabilites]]). L'axe vertical, lui, gagne à être écrêté, par exemple à dix fois le capital initial. Sans cela, les scénarios composés à 30-40 ans, qui peuvent atteindre 20-50 fois la mise, écraseraient visuellement la zone du zéro, celle qui motive pourtant tout l'exercice. C'est un choix de représentation assumé : on sacrifie le spectacle de la queue haute pour garder lisible la queue basse, celle qui décide.
...
**La médiane d'un plan sain monte.** À un retrait de 3-3,5 % et un rendement réel espéré supérieur ([[rendements-attendus]]), le scénario central croît plus vite qu'on ne ponctionne : la médiane à 30 ans dépasse souvent le double du capital initial en termes réels. Voir en même temps une médiane opulente et des chemins rouges n'est pas une contradiction. C'est la définition même d'un plan de retrait, dont l'asymétrie (médiane riche, queue basse ruinée) est irréductible ([[horizon-et-esperance-de-vie]] explique pourquoi survivre aux 30 premières années suffit presque toujours).
...
L'erreur conceptuelle la plus profonde du fan chart mérite son encart, et la figure d'anatomie la montre. Le « 5e percentile » tracé n'est **pas** un scénario. C'est la couture de milliers de scénarios différents, chacun n'occupant ce rang qu'un moment. Une vraie trajectoire du pire décile visite d'ordinaire la bande médiane certaines années. Et, à l'inverse, la trajectoire qui finit ruinée a souvent passé ses premières années dans la moitié haute, exactement comme le chemin rouge de la figure d'anatomie (deux belles années avant le plongeon, c'est le millésime 2000, [[etude-trinity]]). Conséquence pratique : on ne peut pas lire sur le cône « si je suis sous le 10e percentile en année 5, je finirai ruiné ». Le cône ne contient pas les probabilités conditionnelles le long des chemins. Cette question (« où en suis-je, et que dois-je en conclure ? ») est légitime et cruciale, mais elle exige un autre outil : le suivi par seuils de taux de retrait courant ([[quand-s-inquieter]]), pas la contemplation du cône.
:::
...
::: astuce Mise en pratique : manipuler un vrai cône
Rien ne vaut un cône vivant, calculé sur votre propre plan. Un quart d'heure suffit. Dans le simulateur FIRE de pofo, la section des futurs simulés affiche quatre cônes du même plan, à la même échelle, un par modèle de marché.

- Commencez par le cône central, seul. Repérez la médiane, la bande 25-75, la bande 5-95, la ligne de zéro.
- Passez au cône le plus dur, celui de la décennie perdue. Comparez les deux bas de cône avant de comparer les deux médianes.
- Suivez ensuite les huit chemins d'exemple. Comptez les rouges, ceux qui ont touché zéro, et vérifiez qu'aucun ne longe sa bande bien longtemps.
- Basculez enfin la règle de retrait, du fixe indexé vers une règle flexible. Le bas du cône remonte, et l'éventail des dépenses servies montre ce que cette sécurité coûte à vivre.

Le même parcours se fait ailleurs, dans tout outil qui trace une distribution de trajectoires (TPAW Planner et Portfolio Visualizer en bandes de percentiles, cFIREsim et FICalc en faisceau de millésimes historiques). Il faut seulement relancer le calcul modèle par modèle, puis garder les cônes côte à côte sous les yeux.
:::
...
**La distribution des héritages.** La coupe finale du cône de richesse, présentée en histogramme : combien reste-t-il au bout, dans tous les futurs ? La lecture type d'un plan sain choque toujours un peu. La masse est loin au-dessus du capital initial, car on meurt le plus souvent riche ([[une-annee-de-plus]], [[depenses-en-retraite]]), avec une petite barre à zéro : la ruine, vue de l'autre bout.
...
Plan : 1,6 M€, 55 000 €/an avec guardrails, 48 ans d'horizon. Regard 1, les cônes des différents modèles côte à côte : formes semblables, mais le bas du cône du modèle mondial (broad-sample) s'enfonce nettement plus vite. L'incertitude dominante est donc épistémique, le monde compte plus que le hasard. Regard 2, le bas du cône central sur 10 ans : pente douce, un seul chemin rouge sur huit. L'exposition à la séquence est contenue, à ~10 % ou moins. Regard 3, l'éventail des dépenses : le 25e percentile passe 6 ans à −12 % du confort. C'est le prix réel des guardrails, jugé acceptable contre le plancher établi ([[combien-il-vous-faut]]). Regard 4, les causes : les échecs résiduels sont aux trois quarts des « érosions lentes ». La parade prioritaire n'est donc pas plus de cash, mais des briques anti-décennie-perdue ([[portefeuilles-tous-temps]]). Quatre regards, quatre décisions instruites. Voilà ce qu'un fan chart bien lu livre en deux minutes.
:::
...
- Les cônes multi-modèles, les éventails de dépenses, d'héritages et de causes : [[utiliser-la-page-fire]] et [[la-machine-pofo]].
