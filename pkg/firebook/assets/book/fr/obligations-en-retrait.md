...
**2. La duration : par service, pas par vue de taux.** Chaque service impose son horizon, donc sa duration, et la grille de fin de chapitre les fixe brique par brique. Le gros du travail se fait en intermédiaire, le compromis entre l'amortisseur et le risque de taux, avec l'aggregate euro ou les fonds d'État 5-10 ans. La dose longue, elle, reste optionnelle et assumée ([[portefeuilles-tous-temps]]). Ce qu'on ne fait pas, c'est piloter la duration sur des prévisions de taux. Le marché des taux est le plus efficient du monde, et votre vue n'y a pas d'avantage ([[pieges-des-simulateurs]] montre que le timing, partout, détruit de la valeur).
