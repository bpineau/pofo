...
**Service 2 : financer les retraits pendant les creux.** C'est le service logistique. Pendant que les actions récupèrent, ce qui prend de 1 à 7 ans ([[regimes-de-marche]]), les retraits se prélèvent sur la poche obligataire, stable ou en hausse. C'est le prélèvement-rééquilibrage ([[retrait-fixe-bengen]]), et la vraie mécanique derrière l'intuition des buckets ([[strategie-buckets]]). Il exige de la qualité (voir plus bas) et une duration courte à intermédiaire, car la poche doit être stable au moment où on la consomme.
...
Le plan : 1,6 M€, 65 % actions, 35 % défensif, phase à découvert de 14 ans. La poche défensive remplit la grille, service par service, en points de portefeuille. Buffer et retraits proches, 8 % en fonds euros (service 2, zéro vol). Cœur amortisseur, 12 % en obligations d'État euro 5-8 ans (service 3, et service 1 en régime désinflationniste). Assurance-déflation, 4 % en État euro 15 ans et plus (service 1 version puissante, dose assumée). Ligne inflation, 8 % en linkers euro courts plus 3 % d'or ([[obligations-indexees]], [[or-en-retrait]]). La vérification en simulation, contre la même allocation en « 35 % aggregate », donne un scénario central équivalent, une ruine plus basse de 1,2 point sous le stress de séquence et de 1,8 point sous l'échantillon mondial, et le millésime 1973 qui traverse. La poche a un cahier des charges, et chaque ligne un métier. C'est tout ce que « les obligations » veulent dire.
:::
