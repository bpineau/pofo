...
**Rôle 1 : la brique anti-régime du portefeuille (5-10 %).** C'est le rôle central de ce livre. Il s'agit de couvrir les lignes « inflation persistante » et « crise de confiance » de la table des défenses ([[actifs-defensifs]]), celles que le portefeuille français type laisse à découvert. La dose utile mesurée par les simulations est de 5-10 %. En dessous de 5 %, l'effet est cosmétique. Au-delà de 10 %, on ne couvre plus, on parie ; le Golden Butterfly et Browne montent à 20-25 %, la borne haute historique, avec la dépendance épistémique déjà critiquée ([[portefeuilles-tous-temps]]). Le partage moderne de la ligne inflation, c'est moitié or, moitié linkers, c'est-à-dire les obligations indexées ([[obligations-indexees]]). Deux mécanismes différents, la confiance et le contrat, pour le même ennemi.

**Rôle 2 : la réserve de queue politique (2-5 %, hors portefeuille).** C'est l'or physique détenu en propre, sous forme de pièces, comme assurance contre les scénarios hors modèle : crise monétaire majeure, rupture du système financier ([[hyperinflation-et-extremes]], [[pieges-des-simulateurs]], « ce qui n'est pas dans le modèle n'existe pas »). C'est un choix de tempérament plus que d'optimisation. Il ne se simule pas, il se plafonne à quelques pour cent, et il a ses coûts propres : stockage, assurance, prime sur pièces.
...
- Trois rôles, trois doses : brique anti-régime 5-10 % (moitié or, moitié linkers), réserve de queue politique 2-5 % en physique (factures !), pari tactique 0 %.
