...
::: figure vpw-table
On top, the table: the rate starts just above the assumed return, stays almost flat for twenty-five years, then takes off as the horizon shortens. Below, the life that table produces for a household retiring at 40 with EUR 1M, if the market delivers exactly the assumed returns. Income is perfectly flat and capital melts to zero at 100: that is the annuity property, not an accident. The dotted line shows the rule's other face. A 30% crash at 70 takes income from EUR 38.5k down to EUR 27.0k **and it never comes back**, because VPW smooths nothing: it recomputes.
:::
...
**The pension bridge** is the worksheet's other practical innovation. Before your pensions start ([[us-healthcare-and-social-security]]), VPW sets aside, virtually, the capital needed to "manufacture" the missing pension through the bridge years, for example 15 years × EUR 15,000 for a pension starting at 67. It invests that in bonds and applies the percentage only to what is left. It is the uncovered phase / covered phase split of [[horizon-and-life-expectancy]], made operational: the permanent need is amortized, the temporary need is provisioned.

::: figure vpw-pont
The bridge, on the household in the example below. The lower band is the income that does not exist yet: twenty slices of EUR 21.6k drawn from the EUR 356k of bonds set aside, then the pension itself, which takes over without the household noticing. The upper band is VPW applied to the rest. **The top edge is flat: at 67 income does not step up, it simply changes hands.** Without the bridge, the same household would live twenty years on EUR 64.3k before jumping to EUR 85.9k, which is too little while it is young and too late once it is not.
:::
...
Nora and Malik, 47, EUR 1.6M, 60/40, pensions estimated at EUR 21,600 a year from 67, floor EUR 38,000, comfort EUR 52,000. The bridge provisions the twenty missing pension years, discounted at 1.9% real, which is EUR 356,000 held in bonds. VPW applies to the rest, EUR 1,243,000 at 47, the 60/40 table at 4.0%, that is EUR 50,000. Add the bridge slice, EUR 21,600 a year, for an initial income of EUR 71,600. Now the tolerance test, stocks −50%. The VPW sleeve falls to EUR 870,000 and its share of income to EUR 35,000, but the bridge does not move, since it sleeps in bonds. The household therefore still lives on EUR 56,600, above its comfort level and far above its floor. Without the bridge, the same rule would have served EUR 64,300 for twenty years, then EUR 85,900 all at once at 67, and the crash would have cut it to EUR 45,000, below comfort. Twenty years later, pensions running, VPW draws 5.0% of what is left for comfort and for projects. Two regimes, one table, zero forecasting. That is well-built VPW.
:::
