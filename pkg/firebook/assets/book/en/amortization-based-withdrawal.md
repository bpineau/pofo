...
**2. The horizon n and the bequest.** Zero at the horizon is the default setting. To leave something behind, subtract from W the present value of the bequest you target. Leaving EUR 300,000 real thirty years from now means amortizing W minus their present value, about EUR 115,000 at a g of 3.2% real. The bequest becomes a **number you chose**, not an accidental leftover ([[spending-in-retirement]]). For longevity past n, the answer is VPW's: an annuity late in the run ([[annuities-and-safety-first]]), or an n already taken at the 90th percentile.
...
Solène and Marc are 49. Their horizon runs to 99, so 50 years. The portfolio is worth EUR 1.55M, the pensions EUR 19,000 a year from 67 (present value about EUR 310,000), and the bequest they target EUR 200,000 real (present value about EUR 90,000). The marked-down return g is 3.2% real.

The wealth to amortize is therefore 1,550 + 310 − 90 = EUR 1,770,000. The 50-year annuity at 3.2% works out to about 4.05% of W, that is **EUR 71,700**. Subtract the tax on the withdrawal and they live on roughly EUR 66,000 net.

The next year opens two worlds. If the market does −18% (the portfolio at EUR 1.21M), then W = EUR 1,440,000 and n = 49, which gives an annuity of about EUR 58,700 gross, down 18%. Amortization does not protect you from the shock, it only spreads out the consequences. What really cushions it is the matched share of total wealth, and here that share is only 17%. The same crash in a household whose discounted pension makes up half its wealth cuts the annuity by half as much.

If the market does +12%, the annuity rises to about EUR 79,300, up 11%. Ten years of that give an income that breathes by 5 to 8% a year around a tilt you chose, with no cliff and no ratchet. And the EUR 200,000 bequest builds itself quietly inside the formula.
:::
