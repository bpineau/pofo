...
An index future posts only a fraction of its exposure as collateral. A fund can therefore hold 90% in stocks outright and layer 60% of bonds on top through futures: 150% of exposure for EUR 100 invested, with the 50% above capital financed implicitly at the short rate. Holding EUR 67 of that fund is the same as a plain 60/40. That leaves you EUR 33 for trend or gold with nothing sold. Leverage here is not there to amplify a bet. It is there to fit more diversification into the same portfolio.
:::
...
Three ways to invest EUR 100: the leverage held inside the fund carries exposure beyond the capital invested, and the stacked version holds its 60/40 and its diversifiers at the same time.
:::
