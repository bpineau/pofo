...
<!-- source: glidepaths @ bbdbd9ac0333 -->
...
Replay the same tent on the same US history and change nothing but the material of the sleeve, and two clear answers come out. The price of the path does not depend on it: the median vintage pays between 0.25 and 0.29 points and the hardest-hit one between 1.09 and 1.14, whether the sleeve holds bills, 5-year Treasuries, long government bonds or half and half. The level of the sustainable rate does depend on it, and its sign has flipped exactly once in forty-three start years. The long sleeve cost on all twenty-six departures from 1954 to 1979 and paid on the seventeen that followed. So it weighed on the tightest departures and helped the ones that needed nothing. At the worst vintage in the sample, 1966, it takes away a quarter of a point of sustainable rate where bills add a little.

::: figure tente-matiere
Same tent, same history, one thing changes: the material of the defensive sleeve. On top, what each departure could sustain on 5-year Treasuries. Underneath, what bills and the 20-year government bond add to that rate or take from it. The long sleeve costs on all twenty-six departures from 1954 to 1979 and pays on the seventeen that follow. One sign change in forty-three vintages, and it lands on the side where departures were tightest. The sample holds one bond bear market and one bull, which is too little to call it a law; it is enough to show that the material is not neutral.
:::
