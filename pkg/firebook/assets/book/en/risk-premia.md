...
<!-- source: primes-de-risque @ 3b720bb0c89f -->
...
Every asset over the same 57 years: what it returned in the ten worst years for equities (horizontal, the pain at the wrong moment) and what it paid above cash (vertical, the wage). The five assets that claim a premium sit on one line. Gold is paid 4.0 points more than its pain justifies, which is another way of saying it collects no premium at all: what the window credits it with is the monetary repricing of 1971-1980, not a wage.
:::
