...
EUR 15k a year of income in a plan that spends EUR 50k does not "cut withdrawals by 30%". It does four things, and three of them run against intuition.
...
The couple's public pension: the official estimates give EUR 31k a year at 67, a 15% haircut, so **EUR 26k of lifelong flow from year 19** (guaranteed, marked down). The rent on the one-bedroom they kept: EUR 8.4k net-net, a 20% haircut, so **EUR 6.7k of dated flow to year 12** (sale planned at 60, near-certain). Transition unemployment adds **EUR 18k in years 1 and 2** (certain and short). Her likely contract work (about EUR 10k a year), the plausible inheritance and the survivor benefit are **named** in the margins block, and counted nowhere.
