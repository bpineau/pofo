...
One household, seven times. It starts with **$600,000** and wants **$2,000 a month**, $24,000 a year, which makes an initial withdrawal rate of 4.0%, exactly Bengen's number ([[the-4-percent-rule]]). It draws no pension, earns nothing on the side, pays no tax and keeps no cash. Every one of those simplifications flatters the seven rules the same way, so none of them changes the comparison. They only make each number a little more generous than real life ([[cash-buffer]]).
...
::: cle Everything is in constant dollars
...
Seven lives inside the same crisis. The fixed rule is the straight line: it pays $24,000 for forty years without flinching. The other six cut, and the shape of the cut is what tells them apart. The bounded percentage steps down over some fifteen years and the household barely feels the slide. Both guardrails dive fast and deep, then climb very high. VPW tracks the market with no shock absorber, year after year.
:::

| Rule | Average income | Variability | Worst year | Lean years | Ending capital |
|---|---|---|---|---|---|
| Fixed (inflation-adjusted) | 24.0 | 0% | 24.0 | 0 | 20 |
| Flex −10% | 22.0 | 4% | 21.6 | 33 | 344 |
| Guardrails (GK) | 23.5 | 33% | 14.2 | 23 | 779 |
| Risk-based guardrails | 25.6 | 39% | 12.8 | 19 | 759 |
| Bounded % | 21.4 | 16% | 16.0 | 28 | 574 |
| Amortization (ABW) | 30.8 | 35% | 15.3 | 13 | 0 |
| % of portfolio (VPW) | 24.5 | 33% | 12.4 | 19 | 733 |

Income in thousands of dollars a year, ending capital in thousands of dollars, all in constant dollars. Variability is the coefficient of variation of annual income, its spread measured against its own mean, and it is the yardstick for how much the rule moves the household's life around. Lean years count the years lived below the $24,000 planned, out of forty.

The fixed rule held. It paid what it owed forty years running and ends with $20,000 in the account, three percent of what it started with. One more market year in the wrong direction and that column would be telling a story of ruin. That is the true nature of this rule, and the right word is cliff rather than risk. Everything is fine until the second nothing is.

The two guardrails are the exact opposite. They saved the capital, more than $750,000 at the finish, but they had the household living on $14,200 and then $12,800 through most of the 1970s and 1980s. Those are cuts of 40 to 47%, held for more than a decade. The success rate of those columns is perfect and the standard of living they describe is anything but ([[guyton-klinger]]).

In between sit two honest and very different answers. The bounded percentage goes all the way down to $16,000, but it takes sixteen years to get there, in steps of 2.5% a year. Nobody lives a 2.5% cut as a crisis; you live it as a slightly tight year, and that is exactly what the rule is for ([[floor-and-ceiling]]). Amortization pays the highest average income of the seven, $30,800 a year, and it ends at zero. That is not a failure, it is the definition: every year it priced the payment that exhausts the capital over the remaining horizon, and the horizon ended ([[amortization-based-withdrawal]]).
...
Seven lives inside the same tailwind. The fixed rule and its flexible variant stay glued to their $24,000 line while the other five climb. Amortization reaches $82,000 at the 2022 peak. Guardrails, the bounded percentage and VPW settle around $47,000 on average, twice the original plan.
:::

| Rule | Average income | Variability | Worst year | Lean years | Ending capital |
|---|---|---|---|---|---|
| Fixed (inflation-adjusted) | 24.0 | 0% | 24.0 | 0 | 3,812 |
| Flex −10% | 23.8 | 3% | 21.6 | 3 | 3,829 |
| Guardrails (GK) | 46.6 | 26% | 24.0 | 0 | 1,644 |
| Risk-based guardrails | 32.9 | 16% | 21.6 | 7 | 3,037 |
| Bounded % | 47.2 | 25% | 24.0 | 0 | 1,564 |
| Amortization (ABW) | 58.2 | 23% | 29.1 | 0 | 0 |
| % of portfolio (VPW) | 46.3 | 22% | 24.0 | 0 | 1,442 |

The fixed rule dies with $3.81M of constant dollars in the account, after forty years of living on $2,000 a month. It multiplied its capital by six and did nothing with it. Nobody calls that a failure, because the word ruin does not apply, and yet the household gave up half of its retirement. Amortization lived the same period on $58,200 a year on average, two and a half times better, and finishes at zero because that was the deal.
...
Two useful caveats. The risk-based guardrails stay well below their cousins, at $32,900, because their corridor is capped at 150% of the planned level on this page; without that cap the rule climbs without limit as the horizon shortens, which is a known pathology and not a performance ([[morningstar-guardrails]]). And the −10% flex rule cuts only three times in forty years, a reminder that flexibility conditioned on a 20% drop almost never fires in a bull market. It is insurance, not an income strategy.
...
Seven lives inside the lost decade. Six rules out of seven have already had the household living below its plan, most of them for more than twenty years. Only the fixed rule held its line, and it has $276,000 left to fund fourteen years at $24,000.
:::

| Rule | Average income | Variability | Worst year | Lean years | Ending capital |
|---|---|---|---|---|---|
| Fixed (inflation-adjusted) | 24.0 | 0% | 24.0 | 0 | 276 |
| Flex −10% | 21.9 | 4% | 21.6 | 23 | 392 |
| Guardrails (GK) | 19.2 | 12% | 17.5 | 23 | 529 |
| Risk-based guardrails | 19.7 | 24% | 15.7 | 21 | 593 |
| Bounded % | 19.5 | 10% | 17.0 | 25 | 513 |
| Amortization (ABW) | 23.8 | 12% | 18.2 | 16 | 317 |
| % of portfolio (VPW) | 19.2 | 12% | 14.8 | 25 | 570 |

Lean years are counted here out of twenty-six, not forty.

Look at the fixed rule's row and do the arithmetic the household would do. It has $276,000 left and fourteen years of plan, a current withdrawal rate of 8.7%. Not one of those fourteen years is funded by anything but luck. The columns that cut have roughly twice the capital for the same distance to go, and they paid for it by living on $19,000 for twenty years. Nobody can say today who was right, and that is the heart of the matter.

::: attention What the last column does not say
A large ending capital is neither a win nor a loss until you know what you wanted it for. For a household with no heirs and nothing to pass on, the $3.81M of the fixed rule in 1985 is a dead loss of standard of living. For a household that wants to leave something behind, or that fears an expensive spell of care at the end of life, it is exactly the goal. The right rule turns on a question that is not financial.
:::
...
The first is that income stability and capital safety are the same resource, spent in two different places ([[withdrawal-strategies-overview]]). The fixed rule bought forty years of peace in 1973 and paid for it with the $20,000 it had left at the end. The guardrails bought $780,000 of capital and paid for it with a decade of lean years. No rule creates comfort. They move it around.

The second is that the shape of a cut counts as much as its depth. The bounded percentage and the guardrails both come down toward $15,000 to $16,000 in 1973. One takes sixteen years, in steps nobody feels; the other gets there in seven, in jumps of 10%. The second is far harder to live with, and the usual metrics give it almost no credit ([[the-psychology-of-spending]]).
