...
Every dollar in the buffer is a dollar taken out of the engine. Protection against the bad sequences is paid for with forgone return in all the others. Good sequences being the majority, the net comes out near zero, plus or minus 0.5 points of failure depending on the rules. So the statistics do not justify a buffer. What justifies it is what it does to you: a retiree who sleeps, who does not improvise in a crash, and who executes the rule. In practice that is worth more than a lot of simulation points ([[the-psychology-of-spending]]).
:::
