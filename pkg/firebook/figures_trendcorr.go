...
// months that contain the 2002 crash, the programme short equities) and May 2010
// (twelve months of the post-crisis rally, the programme long equities). The
// trough is a plateau, not a spike: the six readings from January to June 2003
// all sit within eight hundredths of it, which is the point the article makes.
const (
	trendCorrMinIdx = 27
	trendCorrMaxIdx = 112
)
...
// 2001 to August 2026 (308 windows), each dated by the month that CLOSES it.
//
...
// recomputes all 308 values from pkg/datasets and fails if the plate and the
// record disagree.
//
...
var trendCorrPoints = []float64{-0.25, -0.25, -0.30, -0.35, -0.39, -0.38, -0.38, -0.41, -0.46, -0.43, -0.40, -0.39,
	-0.35, -0.33, -0.31, -0.25, -0.29, -0.34, -0.36, -0.37, -0.33, -0.37, -0.42, -0.42,
	-0.45, -0.48, -0.51, -0.53, -0.51, -0.48, -0.48, -0.45, -0.35, -0.30, -0.27, -0.26,
	-0.18, -0.06, 0.07, 0.08, 0.09, 0.11, 0.09, 0.06, -0.04, -0.08, -0.01, -0.01,
	0.04, 0.01, 0.01, 0.00, 0.00, 0.03, 0.03, 0.08, 0.10, 0.14, 0.08, 0.09,
	0.05, 0.06, 0.03, 0.03, 0.04, 0.05, 0.03, 0.01, 0.05, 0.06, 0.08, 0.08,
	0.07, 0.18, 0.28, 0.33, 0.41, 0.42, 0.55, 0.51, 0.49, 0.48, 0.41, 0.39,
	0.35, 0.27, 0.19, 0.12, 0.08, 0.04, -0.09, -0.20, -0.29, -0.38, -0.42, -0.42,
	-0.45, -0.47, -0.52, -0.53, -0.52, -0.47, -0.46, -0.41, -0.35, -0.19, -0.07, -0.02,
	0.09, 0.19, 0.46, 0.58, 0.62, 0.52, 0.49, 0.43, 0.38, 0.36, 0.36, 0.37,
	0.34, 0.34, 0.36, 0.35, 0.34, 0.41, 0.45, 0.32, 0.23, 0.12, 0.01, -0.01,
	-0.04, -0.08, -0.10, -0.11, -0.16, -0.22, -0.25, -0.30, -0.22, -0.10, -0.05, 0.02,
	0.08, 0.12, 0.08, 0.06, 0.06, 0.19, 0.37, 0.44, 0.43, 0.46, 0.45, 0.48,
	0.49, 0.50, 0.51, 0.52, 0.54, 0.57, 0.61, 0.59, 0.57, 0.48, 0.46, 0.44,
	0.38, 0.32, 0.29, 0.27, 0.29, 0.31, 0.28, 0.17, 0.03, -0.01, -0.01, -0.04,
	-0.12, -0.19, -0.23, -0.26, -0.27, -0.32, -0.34, -0.32, -0.17, -0.14, -0.12, -0.12,
	-0.00, 0.18, 0.26, 0.30, 0.31, 0.53, 0.57, 0.58, 0.53, 0.52, 0.53, 0.55,
	0.56, 0.57, 0.55, 0.54, 0.54, 0.54, 0.53, 0.49, 0.49, 0.48, 0.36, 0.29,
	0.19, 0.08, 0.02, -0.01, -0.00, 0.00, 0.00, -0.03, -0.06, -0.15, -0.08, -0.06,
	0.10, 0.23, -0.01, -0.08, -0.13, -0.16, -0.16, -0.14, -0.09, -0.07, -0.07, -0.07,
	-0.06, -0.10, 0.04, 0.19, 0.28, 0.39, 0.42, 0.43, 0.42, 0.43, 0.50, 0.50,
	0.45, 0.33, 0.18, 0.12, 0.08, 0.03, -0.03, -0.05, -0.13, -0.17, -0.29, -0.30,
	-0.33, -0.31, -0.19, -0.17, -0.17, -0.16, -0.16, -0.16, -0.12, -0.10, -0.09, -0.08,
	-0.07, -0.03, -0.15, -0.17, -0.17, -0.18, -0.17, -0.15, -0.16, -0.11, -0.07, -0.09,
	-0.07, -0.07, -0.10, -0.01, -0.03, -0.01, -0.01, 0.03, 0.04, 0.03, 0.06, 0.08,
	0.09, 0.08, 0.03, -0.12, -0.16, -0.15, -0.18, -0.24,
}
...
func figTrendCorrelation() string {
	...
	// The peak sits in the first half of the plate, so its label reads to the
	// RIGHT of the dot: anchored the other way it runs off the left edge.
	b.WriteString(sTxt(lx+12, 106, 11, figSoft, "start", "600", "mai 2010, douze mois de hausse"))
