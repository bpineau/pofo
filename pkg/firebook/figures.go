...
var figures = map[string]func() string{
	...
	"clavier-leviers":          figClavierLeviers,
	...
	"trend-correlation":        figTrendCorrelation,
	"guardrails-indicateur":    figGuardrailsIndicateur,
	"sinistres-calendrier":     figSinistresCalendrier,
	"echelle-du-cash":          figEchelleDuCash,
	"mc-entrees-vs-tirages":    figMcEntreesVsTirages,
	"or-decennies":             figOrDecennies,
	"millesimes-1966-1982":     figMillesimes1966Vs1982,
	"millesimes-soutenables":   figMillesimesSoutenables,
	"mourir-riche":             figMourirRiche,
	...
	"briques-esperance":        figBriquesEsperance,
	"richesse-totale":          figRichesseTotale,
	"etages-du-plancher":       figEtagesDuPlancher,
	"escalier-recharges":       figEscalierRecharges,
	"escalier-morningstar":     figEscalierMorningstar,
	...
	"preavis-1966":             figPreavis1966,
	"defenses-bulletin":        figDefensesBulletin,
	"douleur-prime":            figDouleurPrime,
	"panier-mediane-plancher":  figMedianePlancher,
	...
	"voyants-1929-1966":        figVoyants19291966,
}
