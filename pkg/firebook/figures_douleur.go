...
var douleurAssets = []douleurAsset{
	...
	{"Portefeuille 60/40", -12.21, 4.82, true, 8, -16, "start", false},
	{"Treasuries 7-10 ans", 0.32, 2.23, true, 8, -22, "start", false},
	{"Treasuries 20 ans et +", -0.66, 1.97, true, -8, 22, "end", false},
