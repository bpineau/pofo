...
var (
	...
	coupeDepth45    = []float64{
		81.2, 64.3, 50.6, 42.9, 37.8, 33.4, 29.7, 26.8, 24.6, 22.5, 21.1, 19.9, 18.9, 18.2,
		17.6, 17.1, 16.6, 16.2, 15.8, 15.5, 15.2, 15.0, 14.7,
	}
	coupeFirst40 = 1
	coupeDepth40 = []float64{
		34.9, 17.8, 12.2, 9.5, 7.5, 5.9, 5.0, 4.4, 3.9, 3.5, 3.1, 2.9, 2.6, 2.5, 2.3, 2.2,
		2.1, 2.1, 2.0, 1.9, 1.9, 1.9, 1.8, 1.8, 1.8, 1.7,
	}
)
